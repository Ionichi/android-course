...
public class AddMahasiswaActivity extends AppCompatActivity {
    ...
    private Spinner _jenisKelaminSpinnerk, _jpSpinner, _statusNikahSpinner;
    ...
    private void initSaveButton() {
        ...
        _saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String jenisKelamin = _jenisKelaminSpinnerk.getSelectedItem().toString();
                ...
                ahc.get(url, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        Log.d("*ionichi*", new String(responseBody));
    ...
    private void initInputs() {
        ...
        _jenisKelaminSpinnerk = findViewById(R.id.jenisKelaminSpinner);
